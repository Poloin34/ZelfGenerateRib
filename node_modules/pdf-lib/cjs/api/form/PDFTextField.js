...
var PDFTextField = /** @class */ (function (_super) {
    ...
    PDFTextField.prototype.getAlignment = function () {
        ...
        // prettier-ignore
        return (quadding === 0 ? alignment_1.TextAlignment.Left
            : quadding === 1 ? alignment_1.TextAlignment.Center
                : quadding === 2 ? alignment_1.TextAlignment.Right
                    : alignment_1.TextAlignment.Left);
    };
    /**
    ...
    PDFTextField.prototype.setAlignment = function (alignment) {
        utils_1.assertIsOneOf(alignment, 'alignment', alignment_1.TextAlignment);
        this.markAsDirty();
